...
MERCHANT_CATEGORY_RULES: List[Tuple[Tuple[str, ...], str, str]] = [
    ...
    (("RESTAURANT", "CAFE", "BAR ", "UBER EATS", "DELIVEROO", "THUISBEZORGD", "MCDONALD", "BURGER", "PIZZA", "TROUBADOUR", "SUSHI", "STARBUCKS", "HMSHOST", "KOFFIE", "SNACKBAR", "CAFETARIA", "EETCAFE", "BAKKERIJ", "COFFEE", "KFC", "SUBWAY", "LA PLACE", "VAPIANO", "GRILL", "TWISTER AMSTELVEEN"), "Eating Out", ""),
    (("AIRBNB", "HOTEL", "HOSTEL", "KLM", "TRANSAVIA", "RYANAIR", "EASYJET", "EXPEDIA", "TUI", "SUNWEB", "BOOKING.COM", "BOOKING COM", "VRBO", "FLIGHT", "AIRLINE", "TURKISH AIRLINES", "LANDAL", "PEGASUS", "AJET HAVA", "AJET", "VUELING", "DISNEY TICKETS", "DISNEYLAND", "EURODISNEY", "ST PAULS", "IBIS", "ERICVOKEL SAGRADA", "MANVA PMS", "MARRIOTT", "HOF VAN SAKSEN", "NOOITGEDACHT", "CENTER PARCS", "ROOMPOT", "RESORT"), "Holiday", ""),
    ...
    (("AMAZON", "BOL.COM", "IKEA", "H&M", "H & M", "HEMA", "C&A", "ZARA", "COOLBLUE", "MEDIA MARKT", "DECATHLON", "THEPHONELAB", "ACTION", "UNIQLO", "LIMANGO", "WEHKAMP", "WE FASHION", "BAMBULAB", "BAMBU LAB", "ARTENCRAFT", "BEEKMAN B.V.", "ONE2TRACK", "APPLE STORE", "BAX SHOP", "BAX-SHOP", "PRIMARK", "ZALANDO", "MEDIAMARKT", "WOOLSOCKS"), "Shopping", ""),
...
BANK_FEE_KEYWORDS = ("BASISPAKKET", "BETAALPAS", "BETAALPAKKET", "PAKKETKOSTEN", "BANKKOSTEN", "KOSTEN ORANJE", "KOSTEN PAKKET")
